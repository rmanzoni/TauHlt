...
//
std::vector<const reco::Candidate*> getTrigObjCandCollections(const edm::Event& evt, const edm::InputTag& collection, const std::string& filtername, trigger::TriggerObjectType type=trigger::TriggerTau) {
