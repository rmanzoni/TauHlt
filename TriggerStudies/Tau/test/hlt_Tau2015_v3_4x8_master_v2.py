...
process.hltAntiKT5PFJetsForTaus = cms.EDProducer( "FastjetJetProducer",
    ...
    doPVCorrection = cms.bool( False ),
    maxRecoveredHcalCells = cms.uint32( 9999999 ),
    rParam = cms.double( 0.4 ), #MB 0.5->0.4
    maxProblematicHcalCells = cms.uint32( 9999999 ),
    doOutputJets = cms.bool( True ),
...
# Add new online taus
execfile("online-tau-rereco_v3.2.py")
...
# Add UCT2015 stuff
if not isMC:
	execfile("uct2015_4x8.py")
else:
	execfile("uct2015_4x8_MC.py")
...
# process.patOut.fileName  = cms.untracked.string('xrood root://eoscms//eos/cms//store/group/phys_higgs/cmshtt/13TeV/pu40bx25/et/PAT/700_v2/standard_2012_like/mypat.yroot')
# import pdb ; pdb.set_trace()
# process.patOut.fileName  = cms.untracked.string('/store/group/phys_higgs/cmshtt/13TeV/pu40bx25/et/PAT/700_v2/standard_2012_like/mypat.yroot')
