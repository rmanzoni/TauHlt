# /users/manzoni/hlt_tau_GRun_pv_iter2regionPT_iter4triplets/V1 (CMSSW_7_0_0_pre9)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/manzoni/hlt_tau_GRun_pv_iter2regionPT_iter4triplets/V1')
)
