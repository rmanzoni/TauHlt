...
## RM
process.hltPixelVerticesPruned = cms.EDProducer(
  'PixelVertexCollectionTrimmer'                   ,
  src            = cms.InputTag('hltPixelVertices'),
  maxVtx         = cms.int32(100)                  , ## 100 means basically dummy, of course
  fractionSumPt2 = cms.double(0.3)                 ,
  minSumPt2      = cms.double(0.)                  , ## 0. is dummy
)
## 
...
process.hltPFJetPixelSeedsFromPixelTracks = cms.EDProducer( "SeedGeneratorFromProtoTracksEDProducer",
    ...
    #usePV = cms.bool( True ),  ## PV constraint, uses the first PixVtx
    InputVertexCollection = cms.InputTag( "hltPixelVerticesPruned" ),
    TTRHBuilder = cms.string( "hltESPTTRHBuilderPixelOnly" ),
...
process.hltIter1PFJetPixelSeeds = cms.EDProducer( "SeedGeneratorFromRegionHitsEDProducer",
    RegionFactoryPSet = cms.PSet( 
      ...
      RegionPSet = cms.PSet(
        ...
        maxNVertices           = cms.int32( 100 ), # dummy, if hltPixelVerticesPruned is used
        precise                = cms.bool( True ),
        deltaPhi               = cms.double( 1.0 ),
        zErrorBeamSpot         = cms.double( 15. ),
        nSigmaZBeamSpot        = cms.double( 3. ),
        zErrorVetex            = cms.double( 0.1 ), #VerticesFixed: halfLength=zErrorVetex 
        originRadius           = cms.double( 0.05 ),
        measurementTrackerName = cms.string( "hltIter1ESPMeasurementTracker" ), 
        deltaEta               = cms.double( 1.0 ),
        vertexCollection       = cms.InputTag( "hltPixelVerticesPruned" ),
        beamSpot               = cms.InputTag( "hltOnlineBeamSpot" ),
        searchOpt              = cms.bool( True ),
        input                  = cms.InputTag( "hltTrackAndTauJetsIter0" ),
        ptMin                  = cms.double( 0.5 )
      )  
#       ComponentName = cms.string( "TauRegionalPixelSeedGenerator" ), # piks only one vtx up
#       RegionPSet = cms.PSet( 
#         precise = cms.bool( True ),
...
process.hltIter2PFJetPixelSeeds = cms.EDProducer( "SeedGeneratorFromRegionHitsEDProducer",
    RegionFactoryPSet = cms.PSet( 
      ...
      RegionPSet = cms.PSet(
        ...
        zErrorBeamSpot         = cms.double( 15. ),
        nSigmaZBeamSpot        = cms.double( 3. ),
        zErrorVetex            = cms.double( 0.05 ), #VerticesFixed: halfLength=zErrorVetex 
        ...
        beamSpot               = cms.InputTag( "hltOnlineBeamSpot" ),
        searchOpt              = cms.bool( True ),
        input                  = cms.InputTag( "hltTrackAndTauJetsIter1" ),
...
process.hltIter3PFJetMixedSeeds = cms.EDProducer( "SeedGeneratorFromRegionHitsEDProducer",
    RegionFactoryPSet = cms.PSet( 
      ...
      RegionPSet = cms.PSet(
        ...
        beamSpot               = cms.InputTag( "hltOnlineBeamSpot" ),
        searchOpt              = cms.bool( True ),
        input                  = cms.InputTag( "hltTrackAndTauJetsIter2" ),
...
process.hltIter4PFJetPixelLessSeeds = cms.EDProducer( "SeedGeneratorFromRegionHitsEDProducer",
    RegionFactoryPSet = cms.PSet( 
      ...
      RegionPSet = cms.PSet(
        ...
        zErrorBeamSpot         = cms.double( 15. ),
        nSigmaZBeamSpot        = cms.double( 3. ),
        zErrorVetex            = cms.double( 1.0 ), #VerticesFixed: halfLength=zErrorVetex 
        ...
        beamSpot               = cms.InputTag( "hltOnlineBeamSpot" ),
        searchOpt              = cms.bool( True ),
        input                  = cms.InputTag( "hltTrackAndTauJetsIter3" ),
        ptMin                  = cms.double( 0.8 )
      )  
#       ComponentName = cms.string( "TauRegionalPixelSeedGenerator" ),
#       RegionPSet = cms.PSet( 
...
process.hltPFMuonMerging = cms.EDProducer( "SimpleTrackListMerger",
    ...
    MinFound = cms.int32( 3 ),
    TrackProducer2 = cms.string( "hltIter2Merged" ), ## RM : pull out iter3 and iter4, use hltIter2Merged here instead
    LostHitPenalty = cms.double( 20.0 ),
    FoundHitBonus = cms.double( 5.0 )
)
...
process.hltPFTauJetTracksAssociator = cms.EDProducer( "JetTracksAssociatorAtVertex",
    ...
    tracks = cms.InputTag( "hltIter2Merged" ), ## RM : pull out iter3 and iter4, use hltIter2Merged here instead
...
process.HLTRecopixelvertexingSequence = cms.Sequence( process.hltPixelTracks + process.hltPixelVertices + process.hltPixelVerticesPruned )
