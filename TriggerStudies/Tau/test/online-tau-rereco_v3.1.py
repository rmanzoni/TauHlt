...
process.hltPFTauPiZerosOnl2.builders[1].qualityCuts.pvFindingAlgo = "highestWeightForLeadTrack" #MB: "combined" does not exist with tags in the release, replaxed by pixelVtx un-friendly one. To be rechecked with "closestInDeltaZ". Also quality cuts for track for vtx finding to be reconsidered
