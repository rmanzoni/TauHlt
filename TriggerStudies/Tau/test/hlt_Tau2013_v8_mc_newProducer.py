...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/mbluj/CMSSW_5_2_8/Tau2013/V8')
)
...
process.hltOverlapFilterIsoMu17PFTau20 = cms.EDFilter( "HLT2MuonPFTau",
    saveTags = cms.bool( True ),
    MinMinv = cms.double( 0.0 ),
    originTag2 = cms.InputTag( "hltIsoMuPFTaus" ),
    ...
    inputTag2 = cms.InputTag( "hltIsoMuPFTau20" ),
...
process.hltOverlapFilterIsoMu17PFTau20Track = cms.EDFilter( "HLT2MuonPFTau",
    saveTags = cms.bool( True ),
    MinMinv = cms.double( 0.0 ),
    originTag2 = cms.InputTag( "hltSelectedIsoMuPFTausTrackFinding" ),
    MinDelR = cms.double( 0.3 ),
    MinPt = cms.double( 1.0 ),
    MinN = cms.int32( 1 ),
    originTag1 = cms.InputTag( "hltL3MuonCandidates" ),
    ...
    MaxDelR = cms.double( 99999.0 ),
    inputTag1 = cms.InputTag( "hltL3crIsoL1sMu14erORMu16erL1f0L2f14QL3f17QL3crIsoRhoFiltered0p15" ),
    inputTag2 = cms.InputTag( "hltIsoMuPFTau20Track" ),
    MaxDphi = cms.double( -1.0 ),
    MaxDeta = cms.double( -1.0 ),
    MaxPt = cms.double( -1.0 ),
    MinDphi = cms.double( 0.0 )
...
process.hltOverlapFilterIsoMu17LooseIsoPFTau20 = cms.EDFilter( "HLT2MuonPFTau",
    saveTags = cms.bool( True ),
    MinMinv = cms.double( 0.0 ),
    originTag2 = cms.InputTag( "hltSelectedIsoMuPFTausTrackFindingLooseIsolation" ),
    MinDelR = cms.double( 0.3 ),
    MinPt = cms.double( 1.0 ),
    MinN = cms.int32( 1 ),
    originTag1 = cms.InputTag( "hltL3MuonCandidates" ),
...
process.hltPreIsoMu17eta2p1LooseIsoPFTau20NoFilters = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltIsoMuPFTauTagInfoStdVtx = cms.EDProducer( "PFRecoTauTagInfoProducer",
    tkminTrackerHitsn = cms.int32( 3 ),
    tkminPt = cms.double( 0.0 ),
    tkmaxChi2 = cms.double( 100.0 ),
    ChargedHadrCand_AssociationCone = cms.double( 0.8 ),
...
process.hltIsoMuPFTausStdVtx = cms.EDProducer( "PFRecoTauProducer",
    Rphi = cms.double( 2.0 ),
    LeadTrack_minPt = cms.double( 0.0 ),
    PVProducer = cms.InputTag( "hltPixelVertices" ),
    ECALSignalConeSizeFormula = cms.string( "0.18" ),
    ...
    HCALSignalConeMetric = cms.string( "DR" ),
    ElecPreIDLeadTkMatch_maxDR = cms.double( 0.015 ),
    PFTauTagInfoProducer = cms.InputTag( "hltIsoMuPFTauTagInfoStdVtx" ),
    ECALIsolConeMetric = cms.string( "DR" ),
    ECALIsolConeSizeFormula = cms.string( "0.5" ),
    UseChargedHadrCandLeadChargedHadrCand_tksDZconstraint = cms.bool( False ),
    Algorithm = cms.string( "ConeBased" ),
...
process.hltIsoMuPFTauTrackFindingDiscriminatorStdVtx = cms.EDProducer( "PFRecoTauDiscriminationByLeadingObjectPtCut",
    MinPtLeadingObject = cms.double( 0.0 ),
    Prediscriminants = cms.PSet(  BooleanOperator = cms.string( "and" ) ),
    UseOnlyChargedHadrons = cms.bool( True ),
    PFTauProducer = cms.InputTag( "hltIsoMuPFTausStdVtx" )
)
process.hltIsoMuPFTauLooseIsolationDiscriminatorNoFilters = cms.EDProducer( "PFRecoTauDiscriminationByIsolation",
    PFTauProducer = cms.InputTag( "hltIsoMuPFTaus" ),
    qualityCuts = cms.PSet( 
      isolationQualityCuts = cms.PSet( 
        minTrackHits = cms.uint32( 8 ),
    ...
    Prediscriminants = cms.PSet( 
      ...
      leadTrack = cms.PSet( 
        Producer = cms.InputTag( "hltIsoMuPFTauTrackFindingDiscriminator" ),
        cut = cms.double( 0.5 )
      )
    ),
    applyOccupancyCut = cms.bool( True ),
...
process.hltIsoMuPFTauLooseIsolationDiscriminatorStdVtxNoFilters = cms.EDProducer( "PFRecoTauDiscriminationByIsolation",
    PFTauProducer = cms.InputTag( "hltIsoMuPFTausStdVtx" ),
    qualityCuts = cms.PSet( 
      isolationQualityCuts = cms.PSet( 
        minTrackHits = cms.uint32( 8 ),
    ...
    Prediscriminants = cms.PSet( 
      BooleanOperator = cms.string( "and" ),
      leadTrack = cms.PSet( 
        Producer = cms.InputTag( "hltIsoMuPFTauTrackFindingDiscriminatorStdVtx" ),
        cut = cms.double( 0.5 )
      )
    ),
    applyOccupancyCut = cms.bool( True ),
...
process.hltIsoMuPFTauTrkIsolationDiscriminatorNoFilters = cms.EDProducer( "PFRecoTauDiscriminationByIsolation",
    PFTauProducer = cms.InputTag( "hltIsoMuPFTaus" ),
    qualityCuts = cms.PSet( 
      isolationQualityCuts = cms.PSet( 
        minTrackHits = cms.uint32( 8 ),
...
process.hltIsoMuPFTauTrkIsolationDiscriminatorStdVtxNoFilters = cms.EDProducer( "PFRecoTauDiscriminationByIsolation",
    PFTauProducer = cms.InputTag( "hltIsoMuPFTausStdVtx" ),
    qualityCuts = cms.PSet( 
      isolationQualityCuts = cms.PSet( 
        minTrackHits = cms.uint32( 8 ),
...
process.hltIsoMuPFTauECalIsolationDiscriminatorNoFilters = cms.EDProducer( "PFRecoTauDiscriminationByIsolation",
    PFTauProducer = cms.InputTag( "hltIsoMuPFTaus" ),
    qualityCuts = cms.PSet( 
      isolationQualityCuts = cms.PSet( 
        minTrackHits = cms.uint32( 8 ),
...
process.hltIsoMuPFTauECalIsolationDiscriminatorStdVtxNoFilters = cms.EDProducer( "PFRecoTauDiscriminationByIsolation",
    PFTauProducer = cms.InputTag( "hltIsoMuPFTausStdVtx" ),
    qualityCuts = cms.PSet( 
      isolationQualityCuts = cms.PSet( 
        minTrackHits = cms.uint32( 8 ),
...
process.hltSelectedIsoMuPFTausTrackFindingStdVtx = cms.EDFilter( "PFTauSelector",
    discriminators = cms.VPSet( 
      cms.PSet(  discriminator = cms.InputTag( "hltIsoMuPFTauTrackFindingDiscriminatorStdVtx" ),
        selectionCut = cms.double( 0.5 )
      )
    ),
    cut = cms.string( "pt > 0" ),
    src = cms.InputTag( "hltIsoMuPFTausStdVtx" )
)
process.hltSelectedIsoMuPFTausTrackFindingLooseIsolationNoFilters = cms.EDFilter( "PFTauSelector",
    discriminators = cms.VPSet( 
      cms.PSet(  discriminator = cms.InputTag( "hltIsoMuPFTauLooseIsolationDiscriminatorNoFilters" ),
        selectionCut = cms.double( 0.5 )
      ),
      cms.PSet(  discriminator = cms.InputTag( "hltIsoMuPFTauTrackFindingDiscriminator" ),
        selectionCut = cms.double( 0.5 )
...
process.hltSelectedIsoMuPFTausTrackFindingLooseIsolationStdVtxNoFilters = cms.EDFilter( "PFTauSelector",
    discriminators = cms.VPSet( 
      cms.PSet(  discriminator = cms.InputTag( "hltIsoMuPFTauLooseIsolationDiscriminatorStdVtxNoFilters" ),
        selectionCut = cms.double( 0.5 )
      ),
      cms.PSet(  discriminator = cms.InputTag( "hltIsoMuPFTauTrackFindingDiscriminatorStdVtx" ),
        selectionCut = cms.double( 0.5 )
...
process.HLTIsoMuLooseIsoPFTauSequence = cms.Sequence( process.hltPFTauJetTracksAssociator + process.hltIsoMuonVertex + process.hltIsoMuPFTauTagInfo + process.hltIsoMuPFTaus + process.hltIsoMuPFTau20 + process.hltOverlapFilterIsoMu17PFTau20 + process.hltIsoMuPFTauTrackFindingDiscriminator + process.hltSelectedIsoMuPFTausTrackFinding + process.hltIsoMuPFTau20Track + process.hltOverlapFilterIsoMu17PFTau20Track + process.hltIsoMuPFTauLooseIsolationDiscriminator + process.hltSelectedIsoMuPFTausTrackFindingLooseIsolation + process.hltIsoMuPFTau20TrackLooseIso + process.hltOverlapFilterIsoMu17LooseIsoPFTau20 )
process.HLTEndSequence = cms.Sequence( process.hltBoolEnd )
process.HLTIsoMuLooseIsoPFTauSequenceNoFilters = cms.Sequence( process.hltPFTauJetTracksAssociator + process.hltIsoMuonVertex + process.hltIsoMuPFTauTagInfo + process.hltIsoMuPFTauTagInfoStdVtx + process.hltIsoMuPFTaus + process.hltIsoMuPFTausStdVtx + process.hltIsoMuPFTauTrackFindingDiscriminator + process.hltIsoMuPFTauTrackFindingDiscriminatorStdVtx + process.hltIsoMuPFTauLooseIsolationDiscriminatorNoFilters + process.hltIsoMuPFTauLooseIsolationDiscriminatorStdVtxNoFilters + process.hltIsoMuPFTauTrkIsolationDiscriminatorNoFilters + process.hltIsoMuPFTauTrkIsolationDiscriminatorStdVtxNoFilters + process.hltIsoMuPFTauECalIsolationDiscriminatorNoFilters + process.hltIsoMuPFTauECalIsolationDiscriminatorStdVtxNoFilters + process.hltSelectedIsoMuPFTausTrackFinding + process.hltSelectedIsoMuPFTausTrackFindingStdVtx + process.hltSelectedIsoMuPFTausTrackFindingLooseIsolationNoFilters + process.hltSelectedIsoMuPFTausTrackFindingLooseIsolationStdVtxNoFilters )

#MB comment out reference path
#process.HLT_IsoMu17_eta2p1_LooseIsoPFTau20_v7 = cms.Path( process.HLTBeginSequence + process.hltL1sMu14erORMu16er + process.hltPreIsoMu17eta2p1LooseIsoPFTau20 + process.hltL1fL1sMu14erORMu16erL1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu14erORMu16erL1f0L2Filtered14Q + process.HLTL3muonrecoSequence + process.hltL3fL1sMu14erORMu16erL1f0L2f14QL3Filtered17Q + process.HLTL3muoncaloisorecoSequenceNoBools + process.HLTL3muonisorecoSequence + process.hltL3crIsoL1sMu14erORMu16erL1f0L2f14QL3f17QL3crIsoRhoFiltered0p15 + process.HLTRecoJetSequencePrePF + process.hltTauJet5 + process.HLTPFTriggerSequenceMuTau + process.HLTIsoMuLooseIsoPFTauSequence + process.HLTEndSequence )
process.HLT_IsoMu17_eta2p1_LooseIsoPFTau20_NoFilters_v7 = cms.Path( process.HLTBeginSequence + process.hltL1sMu14erORMu16er + process.hltPreIsoMu17eta2p1LooseIsoPFTau20NoFilters + process.hltL1fL1sMu14erORMu16erL1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu14erORMu16erL1f0L2Filtered14Q + process.HLTL3muonrecoSequence + process.hltL3fL1sMu14erORMu16erL1f0L2f14QL3Filtered17Q + process.HLTL3muoncaloisorecoSequenceNoBools + process.HLTL3muonisorecoSequence + process.hltL3crIsoL1sMu14erORMu16erL1f0L2f14QL3f17QL3crIsoRhoFiltered0p15 + process.HLTRecoJetSequencePrePF + process.hltTauJet5 + process.HLTPFTriggerSequenceMuTau + process.HLTIsoMuLooseIsoPFTauSequenceNoFilters + process.HLTEndSequence )
...
if 'hltPreExpressCosmicsOutputSmart' in process.__dict__:
    process.hltPreExpressCosmicsOutputSmart.TriggerResultsTag = cms.InputTag( 'TriggerResults', '', 'TauHLT' )

if 'hltPreExpressOutputSmart' in process.__dict__:
    process.hltPreExpressOutputSmart.TriggerResultsTag        = cms.InputTag( 'TriggerResults', '', 'TauHLT' )

if 'hltPreDQMForHIOutputSmart' in process.__dict__:
    process.hltPreDQMForHIOutputSmart.TriggerResultsTag       = cms.InputTag( 'TriggerResults', '', 'TauHLT' )

if 'hltPreDQMForPPOutputSmart' in process.__dict__:
    process.hltPreDQMForPPOutputSmart.TriggerResultsTag       = cms.InputTag( 'TriggerResults', '', 'TauHLT' )

if 'hltPreHLTDQMResultsOutputSmart' in process.__dict__:
    process.hltPreHLTDQMResultsOutputSmart.TriggerResultsTag  = cms.InputTag( 'TriggerResults', '', 'TauHLT' )

if 'hltPreHLTDQMOutputSmart' in process.__dict__:
    process.hltPreHLTDQMOutputSmart.TriggerResultsTag         = cms.InputTag( 'TriggerResults', '', 'TauHLT' )

if 'hltPreHLTMONOutputSmart' in process.__dict__:
    process.hltPreHLTMONOutputSmart.TriggerResultsTag         = cms.InputTag( 'TriggerResults', '', 'TauHLT' )
...
# Tune output, PAT and UCT2015
process.HLT_IsoMu17_eta2p1_LooseIsoPFTau20_NoFilters_v7.replace(
...
# Remove offline filters for rejection studies
if isFake:
	process.offlineSelectionSequence.remove(process.primaryVertexCounter)
	process.offlineSelectionSequence.remove(process.isolatedMuonsCounter)
	process.offlineSelectionSequence.remove(process.isolatedMuonsCounter)
	process.offlineSelectionSequence.remove(process.isolatedTausCounter)
	process.offlineSelectionSequence.remove(process.muTauPairsCounter)

# Replace tau sequences
execfile("online-tau-rereco_v2.py")
process.HLT_IsoMu17_eta2p1_LooseIsoPFTau20_NoFilters_v7.replace(
    process.HLTIsoMuLooseIsoPFTauSequenceNoFilters,
    process.hltIsoMuonVertex+process.hltTauSequence
)
process.HLT_IsoMu17_eta2p1_LooseIsoPFTau20_NoFilters_v7.remove(process.makeHltPatTaus)
