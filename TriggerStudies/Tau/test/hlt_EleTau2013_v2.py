...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/mbluj/CMSSW_5_2_8/EleTau2013/V2')
)
...
process.hltOverlapFilterIsoEle20WP90LooseIsoPFTau20 = cms.EDFilter( "HLT2ElectronPFTau",
    saveTags = cms.bool( True ),
    MinMinv = cms.double( 0.0 ),
    originTag2 = cms.InputTag( "hltSelectedIsoElePFTausTrackFindingLooseIsolation" ),
    MinDelR = cms.double( 0.3 ),
    MinPt = cms.double( 1.0 ),
    MinN = cms.int32( 1 ),
...
process.hltPreEle22eta2p1WP90RhoLooseIsoPFTau20NoFilters = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltIsoElePFTauLooseIsolationDiscriminatorNoFilters = cms.EDProducer( "PFRecoTauDiscriminationByIsolation",
    PFTauProducer = cms.InputTag( "hltIsoElePFTaus" ),
    qualityCuts = cms.PSet( 
      isolationQualityCuts = cms.PSet( 
        minTrackHits = cms.uint32( 8 ),
...
process.hltIsoElePFTauTrkIsolationDiscriminatorNoFilters = cms.EDProducer( "PFRecoTauDiscriminationByIsolation",
    PFTauProducer = cms.InputTag( "hltIsoElePFTaus" ),
    qualityCuts = cms.PSet( 
      isolationQualityCuts = cms.PSet( 
        minTrackHits = cms.uint32( 8 ),
...
process.hltIsoElePFTauECalIsolationDiscriminatorNoFilters = cms.EDProducer( "PFRecoTauDiscriminationByIsolation",
    PFTauProducer = cms.InputTag( "hltIsoElePFTaus" ),
    qualityCuts = cms.PSet( 
      isolationQualityCuts = cms.PSet( 
        minTrackHits = cms.uint32( 8 ),
...
process.hltPFTauTagInfoStdVtx = cms.EDProducer( "PFRecoTauTagInfoProducer",
    tkminTrackerHitsn = cms.int32( 3 ),
    tkminPt = cms.double( 0.0 ),
    tkmaxChi2 = cms.double( 100.0 ),
    ChargedHadrCand_AssociationCone = cms.double( 0.8 ),
...
process.hltPFTausStdVtx = cms.EDProducer( "PFRecoTauProducer",
    Rphi = cms.double( 2.0 ),
    LeadTrack_minPt = cms.double( 0.0 ),
    PVProducer = cms.InputTag( "hltPixelVertices" ),
    ECALSignalConeSizeFormula = cms.string( "0.18" ),
    ...
    HCALSignalConeMetric = cms.string( "DR" ),
    ElecPreIDLeadTkMatch_maxDR = cms.double( 0.015 ),
    PFTauTagInfoProducer = cms.InputTag( "hltPFTauTagInfoStdVtx" ),
    ECALIsolConeMetric = cms.string( "DR" ),
    ECALIsolConeSizeFormula = cms.string( "0.5" ),
    UseChargedHadrCandLeadChargedHadrCand_tksDZconstraint = cms.bool( False ),
    Algorithm = cms.string( "ConeBased" ),
...
process.hltPFTauTrackFindingDiscriminatorStdVtx = cms.EDProducer( "PFRecoTauDiscriminationByLeadingObjectPtCut",
    MinPtLeadingObject = cms.double( 0.0 ),
    Prediscriminants = cms.PSet(  BooleanOperator = cms.string( "and" ) ),
    UseOnlyChargedHadrons = cms.bool( True ),
    PFTauProducer = cms.InputTag( "hltPFTausStdVtx" )
)
process.hltPFTauLooseIsolationDiscriminatorStdVtx = cms.EDProducer( "PFRecoTauDiscriminationByIsolation",
    PFTauProducer = cms.InputTag( "hltPFTausStdVtx" ),
    qualityCuts = cms.PSet( 
      isolationQualityCuts = cms.PSet( 
        minTrackHits = cms.uint32( 8 ),
...
process.hltPFTauTrkIsolationDiscriminatorStdVtx = cms.EDProducer( "PFRecoTauDiscriminationByIsolation",
    PFTauProducer = cms.InputTag( "hltPFTausStdVtx" ),
    qualityCuts = cms.PSet( 
      isolationQualityCuts = cms.PSet( 
        minTrackHits = cms.uint32( 8 ),
...
process.hltPFTauECalIsolationDiscriminatorStdVtx = cms.EDProducer( "PFRecoTauDiscriminationByIsolation",
    PFTauProducer = cms.InputTag( "hltPFTausStdVtx" ),
    qualityCuts = cms.PSet( 
      isolationQualityCuts = cms.PSet( 
        minTrackHits = cms.uint32( 8 ),
...
process.HLTIsoEleLooseIsoPFTauSequenceNoFilters = cms.Sequence( process.hltPFTauJetTracksAssociator + process.hltIsoEleVertex + process.hltIsoElePFTauTagInfo + process.hltIsoElePFTaus + process.hltIsoElePFTauTrackFindingDiscriminator + process.hltIsoElePFTauLooseIsolationDiscriminatorNoFilters + process.hltIsoElePFTauTrkIsolationDiscriminatorNoFilters + process.hltIsoElePFTauECalIsolationDiscriminatorNoFilters )
process.HLTLoosePFTauSequenceStdVtx = cms.Sequence( process.hltPFTauJetTracksAssociator + process.hltPFTauTagInfoStdVtx + process.hltPFTausStdVtx + process.hltPFTauTrackFindingDiscriminatorStdVtx + process.hltPFTauLooseIsolationDiscriminatorStdVtx + process.hltPFTauTrkIsolationDiscriminatorStdVtx + process.hltPFTauECalIsolationDiscriminatorStdVtx )

#process.HLT_Ele22_eta2p1_WP90Rho_LooseIsoPFTau20_v7 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleIsoEG18erORIsoEG20erOREG22 + process.hltPreEle22eta2p1WP90RhoLooseIsoPFTau20 + process.HLTEle22WP90RhoSequence + process.HLTRecoJetSequencePrePF + process.hltTauJet5 + process.hltOverlapFilterIsoEle20CaloJet5 + process.HLTPFTriggerSequenceForTaus + process.HLTIsoEleLooseIsoPFTauSequence + process.HLTEndSequence )
process.HLT_Ele22_eta2p1_WP90Rho_LooseIsoPFTau20_NoFilters_v7 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleIsoEG18erORIsoEG20erOREG22 + process.hltPreEle22eta2p1WP90RhoLooseIsoPFTau20NoFilters + process.HLTEle22WP90RhoSequence + process.HLTRecoJetSequencePrePF + process.hltTauJet5 + process.hltOverlapFilterIsoEle20CaloJet5 + process.HLTPFTriggerSequenceForTaus + process.HLTIsoEleLooseIsoPFTauSequenceNoFilters + process.HLTLoosePFTauSequenceStdVtx + process.HLTEndSequence )
...
if not isMC:
	execfile("pat-and-out_eTau.py")
else:
	execfile("pat-and-out_eTau_MC.py")
...
process.HLT_Ele22_eta2p1_WP90Rho_LooseIsoPFTau20_NoFilters_v7.replace(
	process.HLTEndSequence,
	process.offlineSequence+process.uct2015Sequence+process.HLTEndSequence
)
process.patOut.SelectEvents.SelectEvents = ["HLT_Ele22_eta2p1_WP90Rho_LooseIsoPFTau20_NoFilters_v7"]
...
if isFake:
	...
	process.offlineSelectionSequence.remove(process.isolatedElectronsCounter)
	process.offlineSelectionSequence.remove(process.isolatedTausCounter)
	process.offlineSelectionSequence.remove(process.eleTauPairsCounter)

# Replace tau sequences
execfile("online-tau-rereco_v2.py")
process.HLT_Ele22_eta2p1_WP90Rho_LooseIsoPFTau20_NoFilters_v7.replace(
    process.HLTIsoEleLooseIsoPFTauSequenceNoFilters,
    process.hltIsoEleVertex+process.hltTauSequence
)
process.HLT_Ele22_eta2p1_WP90Rho_LooseIsoPFTau20_NoFilters_v7.remove(process.HLTLoosePFTauSequenceStdVtx)
process.HLT_Ele22_eta2p1_WP90Rho_LooseIsoPFTau20_NoFilters_v7.remove(process.makeHltPatTaus)

process.hltPFTauPiZeros.builders[0].qualityCuts.primaryVertexSrc = "hltIsoEleVertex"
process.hltPFTauPiZeros.builders[1].qualityCuts.primaryVertexSrc = "hltIsoEleVertex"
process.hltTauPFJetsRecoTauChargedHadrons.builders[0].qualityCuts.primaryVertexSrc = "hltIsoEleVertex"
process.hltPFTausNPSansRef.builders[0].qualityCuts.primaryVertexSrc = "hltIsoEleVertex"
process.hltPFTauLooseIsolationDiscriminatorNP.qualityCuts.primaryVertexSrc = "hltIsoEleVertex"
process.hltPFTauLooseIsolationDiscriminator5hitsNP.qualityCuts.primaryVertexSrc = "hltIsoEleVertex"
process.hltPFTauLooseIsolationDiscriminator3hitsNP.qualityCuts.primaryVertexSrc = "hltIsoEleVertex"
process.hltPFTauECalIsolationDiscriminatorNP.qualityCuts.primaryVertexSrc = "hltIsoEleVertex"
process.hltPFTauTrkIsolationDiscriminatorNP.qualityCuts.primaryVertexSrc = "hltIsoEleVertex"
process.hltPFTauTrkIsolationDiscriminator5hitsNP.qualityCuts.primaryVertexSrc = "hltIsoEleVertex"
process.hltPFTauTrkIsolationDiscriminator3hitsNP.qualityCuts.primaryVertexSrc = "hltIsoEleVertex"
